    ...
    <div class="flex max-w-5xl mx-auto gap-6">
      <div class="max-w-sm flex flex-col gap-4">
        ...
        <div class="flex items-center gap-4">
          ...
          <a
            href=""
            class="hover:-translate-y-1 transform transition-all duration-300"
          >
            <svg
      ...
      <div class="flex gap-6">
        <div class="">
          <h1 class="font-bold text-white">Tentang Kami</h1>
          <ul class="flex flex-col gap-2 pt-2 text-gray-300 font-semibold">
            <li>Hubungi Kami</li>
            <li>Artikel</li>
            <li>Karir</li>
            <li>FAQ</li>
            <li>Kebijakan Privasi Syarat dan Ketentuan</li>
          </ul>
        </div>
        <h1 class="font-semibold text-white">Produk</h1>
      </div>
    </div>
  </footer>
</template>
