  ...
  <section class="max-w-7xl mx-auto">
    ...
    <div class="grid grid-cols-2 pt-10">
      ...
      <div class="contact flex flex-col gap-4">
        <div class="space-y-2">
          <h1 class="font-semibold">Alamat Kantor</h1>
          <p>
            Jl. Garnisun No.1, RT.5/RW.4, Karet Semanggi, Kecamatan Setiabudi,
            Kota Jakarta Selatan, Daerah Khusus Ibukota Jakarta 12930
          </p>
        </div>
        <div class="space-y-2">
          <h1 class="font-semibold">Temukan Kami di :</h1>
          <div class="space-y-1">
            <div class="flex gap-2 items-center">
              ...
              <a href="https://wa.me/81110680534" target="_blank"
                >81110680534</a
              >
            </div>
            <div class="flex items-center gap-2">
              ...
              <a
                target="_blank"
                href="https://www.linkedin.com/company/tomps-id/"
                >Audit Flow</a
              >
            </div>
          </div>
